...
- Current USB serial string: `YBLINK-ZIG-0057-DATA6`
...
```text
YBLINK CMSIS-DAP -- 1209:5301-0:YBLINK-ZIG-0057-DATA6
```
...
`YBLINK-ZIG-0057-DATA6` uses conservative timing for SWD request/ACK sampling and
a separate faster timing for the SWD data write phase. On STM32F405RG with
`app.elf` at requested 20000 kHz, the stock target description finished in
41.93 s, and the 32 KiB override finished in 24.46 s.
